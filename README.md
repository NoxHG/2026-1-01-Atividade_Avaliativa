...
- **Aluno**: Luiz heytor do Nascimento
...
- [ OK ] 2. Substitui neste arquivo (`README.md`) de `FIXME` pelo seu nome
- [ OK ] 3. Abrir o VS Code local ou o _codespaces_ para criar os arquivos respostas da avaliação. Preferível o _codespaces_.
- [ OK ] 4. Responder as questões abaixos.
- [ OK ] 5. Publicar no Github suas repostas.
